...
const HomeOffersSlider = observer(({ gradient, title, loading, offers }: Props) => {
						...
						{loading ? (
							...
							offers.map((item: IOffer) => (
								<React.Fragment key={item.id}>
									<TouchableOpacity
										className='mx-2 w-[140px] flex flex-col items-center gap-3 shadow-sm bg-card  rounded-xl p-1.5'
										onPress={() => {
